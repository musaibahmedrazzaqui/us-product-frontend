...
export default function SignupMothersMaidenName({goToNext, goToPrev} : {goToNext : ()=>void, goToPrev : ()=> void}){
    ...
    return(
        <KeyboardAvoidingView behavior='height' style={{
            ...
            paddingHorizontal:20
                ...
                <Formik
                initialValues={{ mothersMaidenName : 'Ghazala Mehfooz' }}
            ...
            >
                ...
                <View style={{
                    ...
                    marginTop:40, 
                    borderWidth:1,
                    borderColor: touched.mothersMaidenName ? (errors.mothersMaidenName ? 'red' : '#19C18F' ) : '#DDDDDD',
                    borderRadius: 6,
                }}>
                <TextInput 
                ref={emailInputRef}
                ...
                onBlur={handleBlur('mothersMaidenName')}
