...
const SignupSchema = Yup.object().shape({
    nextOfKinName: Yup.string().min(1).required('Required'),
  });


export default function SignupNextOfKinName({goToNext, goToPrev} : {goToNext : ()=>void, goToPrev : ()=> void}){
    ...
    return(
        <KeyboardAvoidingView behavior='height' style={{
            ...
            paddingHorizontal:20
                ...
                <Formik
                initialValues={{ nextOfKinName : 'Jamal Ahmed' }}
            ...
            >
                ...
                <View style={{
                    ...
                    marginTop:40, 
                    borderWidth:1,
                    borderColor: touched.nextOfKinName ? (errors.nextOfKinName ? 'red' : '#19C18F' ) : '#DDDDDD',
                    borderRadius: 6,
                }}>
                <TextInput 
                ref={emailInputRef}
                ...
                onChangeText={handleChange('nextOfKinName')}
