...
const SignupSchema = Yup.object().shape({
  ...
  function ToolTipComponent({setSelectedStatus} : {setSelectedStatus : any}) {
    const MaritalStatuses = ['Single / Never Married', 'Married', 'Divorced', 'Seperated', 'Widow/Widower']
...
export default function SignupMaritalStatus({goToNext, goToPrev} : {goToNext : ()=>void, goToPrev : ()=>void}){
